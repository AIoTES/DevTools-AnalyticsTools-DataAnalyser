...
module.exports = {
	...
	// options: {
	//		attributes: attributes of data element to use as point coordinates
	//		nNeigh: the number of nearest neighbors to consider
    // }
    // TODO: Service is not written very well, it is slow for large data. Consider re-writing it, or using an existing Python library.
	lof: function(data, options) {
